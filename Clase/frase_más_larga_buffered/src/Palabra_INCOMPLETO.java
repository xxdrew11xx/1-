...
public class Palabra_INCOMPLETO {
    ...
    static void longestword(File data){
        ...
        try 
        {
            ...
            BufferedReader br = new BufferedReader(new FileReader(data.getCanonicalPath()));
                ...
                for(int i = 0; i < lineas; i++)
                {
                    ...
                    for(int j = 0; j < frase.length(); j++)
                    {
                        ...
                        if(frase.charAt(j) != ' ')
                        {
                            ...
                            word = word + frase.charAt(j);

                        }
                        else
                        {

                            if(longestword.length() == word.length() && longestword == "")
                            {
                ...
                System.out.print("\n[!] La palabras o palabras más largas del archivo son: " + longestword);


            br.close();    


            // BufferedReader br2 = new BufferedReader(new FileReader(data.getCanonicalPath()));
